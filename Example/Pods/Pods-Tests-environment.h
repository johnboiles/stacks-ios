...
// stacks-ios
#define COCOAPODS_POD_AVAILABLE_stacks_ios
#define COCOAPODS_VERSION_MAJOR_stacks_ios 0
#define COCOAPODS_VERSION_MINOR_stacks_ios 1
#define COCOAPODS_VERSION_PATCH_stacks_ios 0
